...
const playfair = Playfair_Display({
	...
	display: 'swap',
	// Do not preload decorative display font on mobile to reduce LCP impact
	preload: false,
})
const inter = Inter({
	subsets: ['latin'],
...
export const metadata: Metadata = {
	...
	description:
		'A trusted partner for the future of tourism. Over 40 years of experience in hospitality consulting, hotel management, and digital innovation.',
	keywords: [
		'tourism consulting',
		'hotel management',
	...
	twitter: {
		...
		title: 'YST Media | Tourism Consulting Excellence',
		description:
			'A trusted partner for the future of tourism. Over 40 years of experience in hospitality consulting.',
		images: ['/og-image.png'],
	},
	alternates: {
