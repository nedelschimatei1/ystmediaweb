		...
		>
			<style
				dangerouslySetInnerHTML={{
					__html: `
        [data-critical-hero]{min-height:80vh;padding-top:5rem;padding-bottom:5rem}
        [data-critical-hero] h1{font-size:1.85rem;line-height:1.08;margin:0}
        @media (min-width:640px){[data-critical-hero] h1{font-size:2.5rem}}
        @media (min-width:1024px){[data-critical-hero] h1{font-size:3.5rem}}
      `,
				}}
			/>
