...
export function ContactForm() {
	...
	const services = [
		{
			key: 'services.hotelManagement',
			label: t('services.hotelManagement.title'),
		},
		{
			key: 'services.certifications',
			label: t('services.certifications.title'),
		},
		{
			key: 'services.mysteryShopper',
			label: t('services.mysteryShopper.title'),
		},
				...
				{formData.service === 'other' && (
					<div>
						...
						<input
							...
							className="w-full px-4 py-3 bg-background border border-border rounded-xl text-foreground text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all duration-300"
							placeholder={
								t('contact.form.otherServicePlaceholder') ||
								'Spuneți-ne ce servicii doriți...'
							}
						/>
					</div>
				)}
