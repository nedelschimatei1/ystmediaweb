...
import { useI18n, loadContactTranslations } from '@/lib/i18n'
...
export function ContactHero() {
	...
	useEffect(() => {
		...
		;(async () => {
			try {
				await loadContactTranslations()
				if (mounted) setRerender((n) => n + 1)
			} catch (e) {
				console.warn('loadContactTranslations failed', e)
			}
		})()
		return () => {
			mounted = false
	...
	return (
		<section
			className="relative pt-28 pb-6 lg:pt-32 lg:pb-8 overflow-hidden"
			data-critical-hero
		>
			{/* Background */}
